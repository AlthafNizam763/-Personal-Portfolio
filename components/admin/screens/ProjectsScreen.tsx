...
const config: AdminResourceConfig<ProjectDTO & { [key: string]: unknown }> = {
  ...
  fields: [
    ...
    },
    {
      ...
      help: 'Shown on the card — PNG, JPG, WebP, GIF or SVG. Takes precedence over the video if both are set.',
    },
    {
      name: 'video',
      ...
      type: 'video',
      uploadFolder: 'projects',
      help: 'MP4 or WebM. Autoplays muted with controls when no main image is set — clear the main image to use it.',
    },
    {
      name: 'images',
      ...
      uploadFolder: 'projects',
      uploadKind: 'media',
      help: 'Extra screenshots, GIFs or clips stored with the project for future use.',
    },
